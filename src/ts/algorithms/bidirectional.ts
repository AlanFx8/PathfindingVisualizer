...
export default class Bidirectional extends Pathfinder {
    //#region Public
    public GetBidirectional = (startNode: Node,
        endNode: Node, diagonals: boolean): Node[] =>
    {
        //Prepare lists
    ...
    //#region Helpers
    private connectPaths = (lastStart: Node, lastEnd: Node): void => {
        let current = lastEnd;
        let prev = null;
        while(current !== null){
    ...
    private isNeighbor = (nodeA: Node, nodeB: Node, useDiagonals: boolean): boolean => {
